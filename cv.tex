...
\small{
    ...
    \cvsection{EXPERIENCE}{
        ...
        \begin{itemize}[leftmargin=*,nosep,label={\tiny$\bullet$}]
            ...
            \item Proximal Optimization and Deep Learning Methods (with applications to designing networks architectures)
    ...
    \cvsection{PROJECTS}{
        ...
        & Objective: develop a surrogate model for electrostatic problem in an idealized MEMS.\\
        & Dataset: meshes with the corresponding solutions.\\
        & Future applications: coupling the surrogate model to solve multiphysics problems.\\
        & Methodology:
        \begin{enumerate}[leftmargin=*,nosep]
            \item Built the meshes making geometric parameters of the domain vary.
            \item Use traditional FEM solver to obtain the solution (of the electrical part of
                  the problem) for each case.
            \item Train a network as a surrogate model for this problem.
        \end{enumerate}\\
