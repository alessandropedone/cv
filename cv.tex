...
\small{
    ...
    \cvsection{EDUCATION}{
        ...
        % & Keywords: PDEs, characteristics method, analyticity/holomorphy, power series, majorant method, Cauchy-Kowalevski, Holmgren and Cartan-Kähler theorems \\
        & Supervisor: Prof. Maurizio Grasselli
    }

    \cvsection{EXPERIENCE}{

        14/09/2026 - 20/11/2026 & \textbf{Master's Thesis, SISSA} \\

        \vspace{0.1em}\\

        29/06/2026 - 03/07/2026 & \textbf{GMT: unraveling the structure of singularities, UniTrento} \\

        \vspace{0.1em}\\

        01/12/2025 - 03/12/2025 & \textbf{Junior Math Days 2025, SISSA} \\
        ...
        22/09/2025 - 26/09/2025 & \textbf{Workshop and Summer School on Applied Analysis 2025, TU Chemnitz} \\
        ...
        23/06/2025 - 27/06/2025 & \textbf{Theorical Foundations of Machine Learning 2025, UniGe} \\
    ...
    \cvsection{PROJECTS}{
        04/2025 - 09/2026 & \textbf{deeponet-for-mems} \\
        & Description: Coupling a DL-ROM with a traditional ROM to solve multi-physics problem (MEMS simple model).\\
        \vspace{0.5em}\\
    ...
    \cvsection{SKILLS}{
        ...
        Relevant Libraries & scikit-learn, TensorFlow, Keras, MIP, FEniCS, FEniCSx, gmsh \\
